...
<body>
  ...
  <div class="row">
  	<div class="col-lg-12">
  		<h1 class="page-header">Edit Data Pekerja</h1>
  	</div>
  </div>
  ...
  <div class="row">
    <div class="col-lg-8">
      <?php
      $id = isset($_GET['id_karyawan']) ? $_GET['id_karyawan'] : '';
      $edit_data = mysqli_query($conn, "SELECT * FROM karyawan WHERE id_karyawan = '$id'");
      while ($data = mysqli_fetch_array($edit_data)) {
      ?>
        <form method="post" enctype="multipart/form-data">
          <div class="form-group">
            <input class="form-control" type="hidden" name="id" value="<?php echo $data['id_karyawan']; ?>">
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            <input class="form-control" type="text" name="tgl_lahir" value="<?php echo $data['tgl_lahir_karyawan']; ?>">
          </div>
          <div class="form-group">
            <input class="form-control" type="text" name="alamat" value="<?php echo $data['alamat_karyawan']; ?>">
          </div>
          <div class="form-group">
            <input class="form-control" type="text" name="email" value="<?php echo $data['email_karyawan']; ?>">
          </div>
          <div class="form-group">
