...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
 <div class="row">
  ...
  <li class="active">Edit Data APD</li>
</ol>
</div>

<div class="row">
 <div class="col-lg-12">
  <h1 class="page-header">Edit Data APD</h1>
</div>
</div>
...
<div class="row">
  <div class="col-lg-8">
    <?php
    $id = $_POST['id'];
    $edit_data = mysqli_query($conn, "SELECT * FROM apd WHERE id_apd = '$id'");
    while ($data = mysqli_fetch_array($edit_data)) {
    ?>
    <form method="POST" action="doupdate.php">
      <div class="form-group">
        <label>ID APD</label>
        <input class="form-control" type="text" name="id" value="<?php echo $data['id_apd']; ?>" readonly='readonly'>
      </div>
      <div class="form-group">
        <label>Nama APD</label>
        <input class="form-control" type="text" name="nama" value="<?php echo $data['nama_apd']; ?>">
      </div>
      <div class="form-group">
